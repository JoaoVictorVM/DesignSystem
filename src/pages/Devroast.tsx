import {
  ...
  AnalysisCardRoot,
  AnalysisCardTitle,
} from "../components/devroast/analysis-card";
import { Badge } from "../components/devroast/badge";
import { Button } from "../components/devroast/button";
import { CodeBlock, CodeBlockHeader } from "../components/devroast/code-block";
import { DiffLine } from "../components/devroast/diff-line";
import {
  LeaderboardRowCode,
  ...
  LeaderboardRowRoot,
  LeaderboardRowScore,
} from "../components/devroast/leaderboard-row";
import { ScoreRing } from "../components/devroast/score-ring";
import { ToggleDemo } from "../components/devroast/toggle-demo";
...
export function Devroast() {
  return (
    <div className="theme-devroast min-h-screen bg-bg-page p-12 space-y-16 max-w-2xl mx-auto">
      <header>
